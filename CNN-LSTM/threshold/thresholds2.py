...
Πραγματοποιήθηκε επιπλέον πειραματισμός με στόχο να αναδειχθεί ο καθοριστικός ρόλος που παίζει
 η πρόβλεψη σε κάθε συγκεκριμένο χρονικό διάστημα ενός βίντεο βάδισης. Διαπιστώθηκε ότι η 
 ταξινόμηση πολύ μικρών χρονικών τμημάτων μπορεί να δημιουργεί «θόρυβο» στις τελικές μετρικές
 αξιολόγησης, εξαιτίας της αυξημένης αστάθειας ή ασυμφωνίας μεταξύ διαδοχικών προβλέψεων.
 Αυτό υποδεικνύει ότι είναι σημαντικό να εξετάζεται η χρονική συνοχή των προβλέψεων και να αποφεύγεται
 η υπερβολική αποδόμηση του βίντεο σε εξαιρετικά σύντομα αποσπάσματα, καθώς ενδέχεται να επηρεάζεται
 αρνητικά η αξιοπιστία της τελικής απόφασης του μοντέλου.
 
 Ταξινόμηση KOA-PD-NM KAI σταδιών KOA(KOA_EL,KOA_MD,KOA_SV)
