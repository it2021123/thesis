# -*- coding: utf-8 -*-
"""
Created on Wed Jun  4 01:14:05 2025
...
Προβλήματα Ταξινόμησεις :
    1)Υγιούς ,μεσαίο στάδιο Οστεοαθρίτιδας
"""
...
df = df[~df['Disease_Level'].str.contains(r'\+?KOA_SV', na=False)]
...
train_random_forest_grouped(x, y_disease_level, groups, "XGBoost - KOA_MD VS NM", class_labels=le_disease_level.classes_,num_class=2)
