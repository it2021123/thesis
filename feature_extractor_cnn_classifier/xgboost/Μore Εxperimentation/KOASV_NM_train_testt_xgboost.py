...
Προβλήματα Ταξινόμησεις :
    1)Υγιούς ,ηπίο στάδιο Οστεοαθρίτιδας
"""
...
train_random_forest_grouped(x, y_disease_level, groups, "XGBoost - KOA_EL VS NM", class_labels=le_disease_level.classes_,num_class=2)
